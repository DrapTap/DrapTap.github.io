...
tiles = function(){ /*Insert your own tiles here*/
	...
	tileTitleText(0,0,0,2,1,'#789600','Welcome','Welcome','This is my temporary portfolio site till I acquire a permanent address.<p> Feel free to reach me at <br> <strong>patricmw@miamioh.edu</strong> if you have any questions!',['','',''],'noClick');
	tileLive(0,2,0,1,1,"#C33","","Scroll to Navigate","","","","",3000,["Welcome","Have fun","And leave suggestions","Enjoy the UI","...although that's still a work in progress, too."],['','',''],"noClick");

	tileFlip(0,0,1,1,1,"#F60","Contact","img/bg/img1.png","<h5 class='white'>Click here</h5>to leave me a message",['Contact','#F60',''],'');
	tileTitleTextImage(0,1,1,2,1,"#F90","external:http://www.users.muohio.edu/patricmw/portfolio/MP.pdf","Resume & About","Click here for a copy of my resume.","img/icons/box_info.png",50,5,2,['','',''],'');
	
	tileImageSlider(0,0,2,1,1,"#BBB","#&slideshows","img/arrows/arrowRight.png",0.3,"<h5 class='align-center'>Go to last tilegroup</h5>",0.5,['','',''],'');
	
	
	/*GROUP 2 */
	tileImg(1,0,0,3,3,"#F60","external:http://www.users.muohio.edu/patricmw/Metro/Woosh.html","img/bg/Laser.jpg",1,1,['Click To Play','#789600','bottom','Motion Reel',true],'');
